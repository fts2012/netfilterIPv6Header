...
uint32_t RecvCommand_is_alive_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t RecvCommand_is_alive_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("RecvCommand_is_alive_args");
...
uint32_t RecvCommand_is_alive_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("RecvCommand_is_alive_pargs");
...
uint32_t RecvCommand_is_alive_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t RecvCommand_is_alive_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("RecvCommand_is_alive_result");
...
uint32_t RecvCommand_is_alive_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
int32_t RecvCommandClient::is_alive()
{
  send_is_alive();
  return recv_is_alive();
}

void RecvCommandClient::send_is_alive()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("is_alive", ::apache::thrift::protocol::T_CALL, cseqid);

  RecvCommand_is_alive_pargs args;
  args.write(oprot_);
...
int32_t RecvCommandClient::recv_is_alive()
{
  ...
  if (fname.compare("is_alive") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  int32_t _return;
  RecvCommand_is_alive_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "is_alive failed: unknown result");
}
...
void RecvCommandProcessor::process_is_alive(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("RecvCommand.is_alive", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "RecvCommand.is_alive");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "RecvCommand.is_alive");
  }

  RecvCommand_is_alive_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "RecvCommand.is_alive", bytes);
  }

  RecvCommand_is_alive_result result;
  try {
    result.success = iface_->is_alive();
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "RecvCommand.is_alive");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("is_alive", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "RecvCommand.is_alive");
  }

  oprot->writeMessageBegin("is_alive", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "RecvCommand.is_alive", bytes);
  }
}
